...
## Download HSPyTools
This library depends on the HSPyTools library. Download this repository as well via the shell or GitHub Desktop-App. The URL is ```https://github.com/arehmer/HSPyTools.git```
...
## Install HSFit
Repeat the same procedure but in the directory where HSFit is located.
...
1. In the conda shell type
   ...
   python
   ```
2. Then try to import HSFit by typing
   ```sh
   import hsfit
   ```
